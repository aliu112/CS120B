...
tests = [ 
    {'description': 'unlock',
    'steps': [ 
        #{'inputs': [('PINA', 0x00)],'iterations':1, 'expected': [('PORTB',0x00),('PORTC',0x00)]},

        {'inputs': [('PINA', 0x04)],'iterations':5, 'expected': [('PORTB',0x00)]}, # Set PIN to val then run one iteration
        {'inputs': [('PINA', 0x00)], 'iterations':5, 'expected': [('PORTB',0x00)] }, # Set PIN to val then run 300 ms
